...
@cached(namespace="clubs.search", ttl="short")
def search_clubs(response: Response, club_name: str, page_number: Optional[int] = 1) -> dict:
...
@cached(namespace="clubs.profile", ttl="long")
def get_club_profile(response: Response, club_id: str) -> dict:
...
@cached(namespace="clubs.players", ttl="short", archive_param="season_id")
def get_club_players(response: Response, club_id: str, season_id: Optional[str] = None) -> dict:
